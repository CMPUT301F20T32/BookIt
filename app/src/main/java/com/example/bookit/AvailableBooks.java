...
public class AvailableBooks extends Fragment {
     ...
     * @return A new instance of fragment AvailableBooks.
     */
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            if (document2.exists()) {
                                                ...
                                                myDataset.add(new Book(document2.get("book_title").toString(), document2.get("author").toString(), document2.get("isbn").toString(), document2.get("status").toString(), document2.get("image_link").toString()));
